...
/**
 * Admin's own account details. Admin has no dedicated profile entity (like Farmer/Buyer) -
 * just the base User fields - so this mirrors DeliveryProfileController's simple pattern.
 */
@RestController
